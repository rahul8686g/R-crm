...
<div align="center">
  <img src="static/favicon.ico" alt="Genie CRM Logo" width="64" height="64">
...
# Database URL
DATABASE_URL=postgres://genie_user:genie_pass@db:5432/genie_db
```
...
```python
DATABASE_URL=postgres://username:password@localhost:5432/genie_crm
```
