...
class LeadsConfig(AppConfig):
    ...
    def get_api_paths(self):
        ...
        return [
            {
                "pattern": "crm/leads/",
                "view_or_include": "genie_crm.leads.api.urls",
    ...
    def ready(self):
        try:
            ...
            __import__("genie_crm.leads.signals")  # noqa: F401
            __import__("genie_crm.leads.menu")  # noqa: F401

            urlpatterns.append(
                path("leads/", include("genie_crm.leads.urls", namespace="leads")),
            )
