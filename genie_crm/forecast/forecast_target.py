...
from genie_core.models import HorillaUser, Period, Role
from genie_crm.forecast.filters import ForecastTargetFilter
from genie_crm.forecast.forms import ForecastTargetForm
