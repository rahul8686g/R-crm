...
from genie_crm.forecast.filters import ForecastTypeFilter
from genie_crm.forecast.forms import ForecastTypeForm
from genie_crm.forecast.models import ForecastCondition, ForecastType
